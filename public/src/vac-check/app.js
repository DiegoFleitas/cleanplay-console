...
// TODO: add sourceban google search
...
const fetchPlayerData = async (player) => {
  ...
  // Uncomment the following lines if you want to fetch source bans data
  // try {
  //   requests.push(playerSourcebansRequest(steamId).then(sourceBansResponse => {
  //     onSourcebansData(sourceBansResponse, steamId);
  //   }));
  // } catch (error) {
  //   console.error(error);
  // }
